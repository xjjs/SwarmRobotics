        ...
        public override void Update(RobotBase robot, RunState state)
        {
            ...
            if (!assignFlag)
            {
                ...
                if (!fileFlag)
                {
                    ...
                    //文件中存储的矩阵是转置形式
                    //StreamReader sr = new StreamReader("parameters-snn-temp6cm.txt");
                    //StreamReader sr = new StreamReader("parameters-snn-temp13m.txt");
                    StreamReader sr = new StreamReader("parameters-snn-temp1cm.txt");
                    ...
                    //CustomRandom rnd = new CustomRandom(robot.virID);


                    //for (int j = 0; j < 30; j++)
                    //{
                    //    for (int i = 0; i < L; i++) w1Array[i, j] = rnd.NextDouble();
                    //}
                    //for (int i = 0; i < 1; i++)
                    //{
                    //    for (int j = 0; j < L; j++) off1Array[j, i] = rnd.NextDouble();
                    //}


                    //for (int j = 0; j < L; j++)
                    //{
                    //    for (int i = 0; i < M; i++) w2Array[i, j] = rnd.NextDouble();
                    //}
                    //for (int i = 0; i < 1; i++)
                    //{
                    //    for (int j = 0; j < M; j++) off2Array[j, i] = rnd.NextDouble();
                    //}

                    //for (int j = 0; j < M; j++)
                    //{
                    //    for (int i = 0; i < N; i++) w3Array[i, j] = rnd.NextDouble();
                    //}
                    //for (int i = 0; i < 1; i++)
                    //{
                    //    for (int j = 0; j < N; j++) off3Array[j, i] = rnd.NextDouble();
                    //}

                    //for (int j = 0; j < N; j++)
                    //{
                    //    for (int i = 0; i < O; i++) w4Array[i, j] = rnd.NextDouble();
                    //}
                    //for (int i = 0; i < 1; i++)
                    //{
                    //    for (int j = 0; j < O; j++) off4Array[j, i] = rnd.NextDouble();
                    //}
                    ...
                    //for (int j = 0; j < O; j++)
                    //{
                    //    for (int i = 0; i < 2; i++) w5Array[i, j] = rnd.NextDouble();
                    //}
                    //for (int i = 0; i < 1; i++)
                    //{
                    //    for (int j = 0; j < 2; j++) off5Array[j, i] = rnd.NextDouble();
                    //}
